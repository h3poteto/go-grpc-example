...
func request_CustomerService_ListPerson_0(ctx context.Context, marshaler runtime.Marshaler, client CustomerServiceClient, req *http.Request, pathParams map[string]string) (CustomerService_ListPersonClient, runtime.ServerMetadata, error) {
...
// RegisterCustomerServiceHandler registers the http handlers for service CustomerService to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "CustomerServiceClient".
...
func RegisterCustomerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CustomerServiceClient) error {
	...
	mux.Handle("GET", pattern_CustomerService_ListPerson_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CustomerService_ListPerson_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_CustomerService_ListPerson_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
